  ...
  <div class="row content">
    <div class="col-sm-2 sidenav">
     <h3>Order Detail</h3>
      ...
      <hr>
      <h3>결제수단</h3>
      <input type="radio" value="신용카드">신용카드<br><br>
    ...
    <div class="col-sm-8 text-left" id="addresinfo">
    	...
    	<input type="text" class="form-control" name="name" value="name" placeholder="name" ><br><br>
    	<label for="phone">전화번호</label><br>
    	<input type="text" id="phone" name="phone" value="phone" placeholder="phone" class="form-control"><br><br>
    	<label for="email">이메일</label><br>
    	<input type="email" id="email" name="email" value="email" placeholder="email" class="form-control" ><br><br>
           ...
           <input type="text" id="sample4_jibunAddress" placeholder="지번주소" class="form-control"><br>
           <span id="guide" style="color:#999;display:none"></span>
           <input type="text" id="sample4_detailAddress" placeholder="상세주소" class="form-control">
           <input type="text" id="sample4_extraAddress" placeholder="참고항목" class="form-control"><br><br>
    </div>
     <div class="col-sm-2 sidenav">
      <div class="well">
        <p>ADS</p>
